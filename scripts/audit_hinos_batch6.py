# -*- coding: utf-8 -*-
"""
Script de auditoria textual e estrutural para o Lote 6 (Hinos 801 a 900) do Hinário Novo.
"""
import re
import sys
...
def audit():
    ALL_HINOS = to_list(HINOS_801_825) + to_list(HINOS_826_850) + to_list(HINOS_851_875) + to_list(HINOS_876_900)
    print(f"Total de hinos carregados: {len(ALL_HINOS)}")
    assert len(ALL_HINOS) == 100, f"Esperado 100 hinos (801 a 900), encontrado {len(ALL_HINOS)}"
    ...
    print("\nTODOS OS 100 HINOS (801 a 900) PASSARAM NA AUDITORIA COM SUCESSO!")
