# -*- coding: utf-8 -*-
"""
Script de verificação final do data/hinosData.json após mesclagem do Lote 6
"""
import json
import sys
...
from scripts.hinos_data_801_825 import HINOS_801_825
from scripts.hinos_data_826_850 import HINOS_826_850
from scripts.hinos_data_851_875 import HINOS_851_875
from scripts.hinos_data_876_900 import HINOS_876_900
...
ALL_NEW_HINOS = to_list(HINOS_801_825) + to_list(HINOS_826_850) + to_list(HINOS_851_875) + to_list(HINOS_876_900)
...
def verify():
    ...
    assert len(novo) == 900, f"Esperado 900 hinos em 'novo', encontrado {len(novo)}"
    ...
    # Verificar integridade dos hinos 801 a 900 contra as fontes
    ...
    print(f"SUCESSO: Todos os 900 hinos em data['novo'] verificados e consistentes!")
