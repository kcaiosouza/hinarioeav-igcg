# -*- coding: utf-8 -*-
"""
Script de mesclagem do Lote 6 (Hinos 801 a 900) no data/hinosData.json
"""
import json
import os
import shutil
...
def main():
    ...
    assert final_count == 900, f"Esperado 900 hinos em 'novo', encontrado {final_count}"
