# -*- coding: utf-8 -*-
"""
Script de mesclagem do Lote 7 (Hinos 901 a 1000) no data/hinosData.json
"""
import json
import os
import shutil
...
def main():
    ...
    assert final_count == 1000, f"Esperado 1000 hinos em 'novo', encontrado {final_count}"
