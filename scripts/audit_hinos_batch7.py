# -*- coding: utf-8 -*-
"""
Script de auditoria textual e estrutural para o Lote 7 (Hinos 901 a 1000) do Hinário Novo.
"""
import re
import sys
...
def audit():
    ALL_HINOS = to_list(HINOS_901_925) + to_list(HINOS_926_950) + to_list(HINOS_951_975) + to_list(HINOS_976_1000)
    print(f"Total de hinos carregados: {len(ALL_HINOS)}")
    assert len(ALL_HINOS) == 100, f"Esperado 100 hinos (901 a 1000), encontrado {len(ALL_HINOS)}"
    ...
    print("\nTODOS OS 100 HINOS (901 a 1000) PASSARAM NA AUDITORIA COM SUCESSO!")
