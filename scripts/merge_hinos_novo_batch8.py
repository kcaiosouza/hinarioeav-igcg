# -*- coding: utf-8 -*-
"""
Script de mesclagem do Lote 8 (Hinos 1001 a 1100) no data/hinosData.json
"""
import json
import os
import shutil
...
def main():
    ...
    assert final_count == 1100, f"Esperado 1100 hinos em 'novo', encontrado {final_count}"
