...
| `N` | **Hinário Novo** | Novo hinário oficial completo *(1100/1100)* |
...
```
[x] Hinário Novo (book key: "novo") — (1100/1100) completo!
    - Cadastro completo das letras dos hinos do Hinário Novo (1 a 1100)
